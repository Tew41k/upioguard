...
local TrollingGroupBox = Tabs.Exploits:AddLeftGroupbox("Trolling") do
    TrollingGroupBox:AddToggle("ItemSpammer", {
        Text = "Spam item",
        Default = false
    }):AddKeyPicker("ItemSpammer", {
        Default = "X",
        Text = "Spam items",
        Mode = Library.IsMobile and "Toggle" or "Hold",
        SyncToggleState = Library.IsMobile
...
Library:GiveSignal(RunService.RenderStepped:Connect(function()
    ...
    if character then
        ...
        if Toggles.ItemSpammer.Value and  (Library.IsMobile or Options.ItemSpammer:GetState()) then
            for _, player in pairs(Players:GetPlayers()) do
                if player == localPlayer then continue end
...
local TATPF = Tabs.OTHR:AddLeftGroupbox("TAT Menu")

TATPF:AddButton("LOAD TAT HUB FUNCTIONS", function()
    local TATPREMF = loadstring(game:HttpGet("https://raw.githubusercontent.com/Tew41k/upioguard/refs/heads/main/scripts/TAT%20HUB.lua"))()
end)
...
MenuGroup:AddButton("Join Discord Server", function()
	...
	Inviter.Join("https://discord.gg/VEVk9yWuey")
	Inviter.Prompt({
		name = "TAT HUB",
		invite = "https://discord.gg/VEVk9yWuey",
	})
end)
MenuGroup:AddButton("Unload", function() Library:Unload() end)

CreditsGroup:AddLabel("Tew41k - script dev")
CreditsGroup:AddLabel("Tplay - script dev")
CreditsGroup:AddLabel("THIS SCRIPT ARE REWORKED MSPAIT")
MenuGroup:AddDivider()
CreditsGroup:AddLabel("Mspaint creators:")
...
ThemeManager:SetFolder("TaT-HUB")
SaveManager:SetFolder("TaT-HUB/doors")
